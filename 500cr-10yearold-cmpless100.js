...
(async () => {
    ...
    try {
        ...
        const excelFilePath = path.join(reportDir, `500cr-10yearold-cmp100less_${timestamp}.xlsx`);
        const pdfFilePath = path.join(reportDir, `500cr-10yearold-cmp100less_${timestamp}.pdf`);
        ...
        while (true) {
            ...
            const url = `https://www.screener.in/screens/2181021/cap-500cr-price-under-100/?page=${pageIndex}`;
        ...
        <table>
            <tr>
                <td>Market cap More Than  500 cr</td>
            </tr>
            <tr>
                <td>10 year old with 10% profit</td>
            </tr>
            <tr>
                <td>Current market price is less 100/-</td>
            </tr>
        </table>
    </div>
                <table>
...
&nbsp;
        ...
        const htmlFilePath = path.join(reportDir, `500cr-10yearold-cmp100less_${timestamp}.html`);
