...
(async () => {
    ...
    try {
        ...
        const excelFilePath = path.join(reportDir, `500cr-10YO-cmp200to500_${timestamp}.xlsx`);
        const pdfFilePath = path.join(reportDir, `500cr-10YO-cmp200to500_${timestamp}.pdf`);
        ...
        while (true) {
            ...
            const url = `https://www.screener.in/screens/2181204/100-current-price-999/?page=${pageIndex}`;
        ...
        <table>
            <tr>
                <td> Market Cap 500+cr | 10% Profit | CMP 100 to 999 </td>
            </tr>
...
&nbsp;
        ...
        const htmlFilePath = path.join(reportDir, `500cr-10YO-cmp200to500_${timestamp}.html`);
