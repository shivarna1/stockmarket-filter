...
(async () => {
    ...
    try {
        ...
        const excelFilePath = path.join(reportDir, `500cr-10yearold-cmp50less_${timestamp}.xlsx`);
        const pdfFilePath = path.join(reportDir, `500cr-10yearold-cmp50less_${timestamp}.pdf`);
        ...
        <table>
            <tr>
                <td>Market cap 500 cr</td>
            </tr>
            <tr>
                <td>10 year old with 10% profit</td>
            </tr>
            <tr>
                <td>Current market price is less 50/-</td>
            </tr>
        </table>
    </div>
                <table>
...
&nbsp;
        ...
        const htmlFilePath = path.join(reportDir, `500cr-10yearold-cmp50less_${timestamp}.html`);
